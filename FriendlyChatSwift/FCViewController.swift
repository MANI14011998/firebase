...
let info = convertFromUIImagePickerControllerInfoKeyDictionary(info)
        ...
        if let photo = info[convertFromUIImagePickerControllerInfoKey(UIImagePickerController.InfoKey.originalImage)] as? UIImage, let photoData = photo.jpegData(compressionQuality: 0.8) {
